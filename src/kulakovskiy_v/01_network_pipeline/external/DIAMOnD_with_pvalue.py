...
# =============================================================================
# THIRD-PARTY CODE — NOT authored by this project.
#
# Original: DIAMOnD.py by Susan D. Ghiassian, Joerg Menche & Albert-Laszlo
#   Barabasi (https://github.com/dinaghiassian/DIAMOnD). See the header below
#   and their publication (Ghiassian et al., PLoS Comput Biol, 2015).
#
# The ONLY modification made for the BIOSEaRCH project is a one-line patch so
# that the per-step hypergeometric p-value (already computed by the algorithm)
# is written to the output file — the upstream code computes but never saves
# it. The gene ranking is unchanged. Modification by Vyacheslav Kulakovskiy.
# The original code retains its original license/terms.
# =============================================================================
